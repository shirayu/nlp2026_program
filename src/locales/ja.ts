export const ja = {
  ...
  zoomImportCodeDescription:
    "import_zoom_settings のURLまたはフラグメント（import_zoom_settings=...）を入力してください。コードはSlackの #_random で別途お知らせいたします。",
  zoomImportCodePlaceholder: "https://...#import_zoom_settings=...",
  zoomImportCodeRun: "インポート確認へ",
  zoomImportCodeRunning: "インポート中...",
  zoomImportCodeInvalid: "入力文字列から import_zoom_settings= を読み取れません。",
  settingsCodeImport: "インポート",
  settingsImportCodeDialogTitle: "設定・ブックマークをコードでインポート",
  settingsImportCodeDescription: "import_settings のURLまたはフラグメント（import_settings=...）を入力してください。",
  settingsImportCodePlaceholder: "https://...#import_settings=...",
  settingsImportCodeRun: "インポート確認へ",
  settingsImportCodeRunning: "インポート中...",
  settingsImportCodeInvalid: "入力文字列から import_settings= を読み取れません。",
  venueA: "A会場",
  venueB: "B会場",
  venueC: "C会場",
  venueP: "P会場",
